 ...
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
 * |BTN1    |  1   |  2   |  3   |  4   |  5   | ESC  |           | BSPC |  6   |  7   |  8   |  9   |  0   |    BTN2|
 * |--------+------+------+------+------+------+------|           |------+------+------+------+------+------+--------|
...
[BASE] = LAYOUT_ergodox(
        // left hand
        KC_BTN1,       KC_1,        KC_2,    KC_3,   KC_4,   KC_5,   KC_ESC,
        ...
        // right hand
        KC_BSPC,      KC_6,   KC_7,   KC_8,   KC_9,   KC_0,      KC_BTN2,
...
[MISC] = LAYOUT_ergodox(
    ...
    // right hand
       ...
       _______,  _______, RGB_RMOD, RGB_TOG, RGB_MOD, _______, _______,
                          _______, _______, _______,  _______, _______,
       _______,  _______,
       _______,
       _______, _______, _______
