...
[_BASE] = LAYOUT_planck_grid(
  ...
  TO(2), OSM(MOD_LGUI), OSM(MOD_LALT), OSM(MOD_LCTL), OSL(1), KC_SPC, KC_SPC, OSL(1), OSM(MOD_RCTL), OSM(MOD_RALT), OSM(MOD_RGUI), TO(2)
),
...
[_LOWER] = LAYOUT_planck_grid(
  ...
  KC_HOME, KC_PGUP, KC_TILD, KC_PIPE, KC_GRV,  _______, _______, KC_BSLS, KC_PLUS, KC_DEL,  KC_INS,  RESET,
...
[_RAISE] = LAYOUT_planck_grid(
  ...
  KC_VOLD, KC_VOLU, KC_MUTE, KC_MPLY, TO(0),   TO(1),   TO(1),   TO(0),   KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
